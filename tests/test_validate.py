...
def _validate(scales, biases, n):
    """Helper: call q4_validate with auto-generated i32 bit views."""
    s = np.ascontiguousarray(scales)
    b = np.ascontiguousarray(biases)
    return q4_validate(s, b, s.view(np.int32), b.view(np.int32), n)
...
class TestValidate:
    def test_valid_data(self):
        ...
        assert _validate(scales, biases, 4) == 0
    ...
    def test_nan_scale(self):
        ...
        assert _validate(scales, biases, 3) == 1
    ...
    def test_nan_scale_first_group(self):
        ...
        assert _validate(scales, biases, 1) == 1
